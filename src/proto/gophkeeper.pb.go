...
type PasswordMessage struct {
	...
	UploadTime    string                 `protobuf:"bytes,4,opt,name=uploadTime,proto3" json:"uploadTime,omitempty"`
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}
...
func (x *PasswordMessage) GetUploadTime() string {
	if x != nil {
		return x.UploadTime
	}
	return ""
...
func (x *FileMessage) GetUploadTime() string {
	if x != nil {
		return x.UploadTime
	}
	return ""
...
func (x *BankCardMessage) GetUploadTime() string {
	if x != nil {
		return x.UploadTime
	}
	return ""
...
type SensetiveDataMessage struct {
	...
	UploadTime    string                 `protobuf:"bytes,2,opt,name=uploadTime,proto3" json:"uploadTime,omitempty"`
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}
...
func (x *SensetiveDataMessage) GetUploadTime() string {
	if x != nil {
		return x.UploadTime
	}
	return ""
...
const file_gophkeeper_proto_rawDesc = "" +
	...
	"\x05login\x18\x02 \x01(\tR\x05login\"\x8b\x01\n" +
	...
	"uploadTime\x18\x04 \x01(\tR\n" +
	"uploadTime\x12\x10\n" +
	"\x03end\x18\x05 \x01(\bR\x03end\"\xaf\x01\n" +
	...
	"\bmetadata\x18\x05 \x01(\tR\bmetadata\x12\x1e\n" +
	"\n" +
	"uploadTime\x18\x06 \x01(\tR\n" +
	"uploadTime\"\\\n" +
	"\x14SensetiveDataMessage\x12$\n" +
	"\ridentificator\x18\x01 \x01(\tR\ridentificator\x12\x1e\n" +
	"\n" +
	"uploadTime\x18\x02 \x01(\tR\n" +
	"uploadTime\"\xc1\x01\n" +
	"\vDataMessage\x12X\n" +
